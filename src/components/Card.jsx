        ...
        <div className="col-md-2">
            <div className="card border-0">
                ...
                <div className="card-body">
                    ...
                    <p className="text-center"><button className="btn btn-warning rounded-pill fw-bold px-3" style={{fontSize:"12px"}} onClick={() => {onClick(item.id)}}>Agregar al Carrito</button></p>
                </div>
            </div>
        </div>
    )
